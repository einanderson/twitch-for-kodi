...
from .utils import the_art, TitleBuilder, i18n, get_oauth_token, get_vodcast_color, get_thumbnail_size, get_refresh_stamp, to_string, get_private_oauth_token, convert_duration, strip_tofu
...
class JsonListItemConverter(object):
    ...
    def _clean_info(info):
        # Emoji/Symbole aus den Freitext-Feldern (Titel/Beschreibung) entfernen, die Kodis
        # Font nicht rendern kann — betrifft Text unterm Bild (tagline) + Info-Dialog (plot).
